  ...
  const programasView = (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{
        ...
        {showFullStory && <>
          <div style={{ fontSize: 14, color: C.muted, lineHeight: 1.8, marginBottom: 14 }}>
            Vivo con altas capacidades — trastorno límite de la personalidad — desde los 16 años. Pasé por malos diagnósticos, por depresión, por un intento de suicidio. Hasta que llegué al DBT y eso me cambió la vida. Me certifiqué como profesora de yoga. Me fui 35 días sola a Grecia sin saber para dónde iba.
          </div>
          <div style={{ fontSize: 14, color: C.muted, lineHeight: 1.8, marginBottom: 14 }}>
