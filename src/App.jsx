    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      {(() => {
        const cards = [
          ...
          { icon: 'emocional', color: '#C9A96E', title: 'DBT me salvó la vida', desc: 'Diana vive con altas capacidades y encontró en la Terapia Dialéctica Conductual las herramientas para transformar su relación con sus emociones.', cta: 'Conoce su historia →' },
  ...
  const programasView = (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{
        ...
        {showFullStory && <>
          <div style={{ fontSize: 14, color: C.muted, lineHeight: 1.8, marginBottom: 14 }}>
            Vivo con altas capacidades — trastorno límite de la personalidad — desde los 16 años. Pasé por malos diagnósticos, por depresión. Hasta que llegué al DBT y eso me cambió la vida. Me certifiqué como profesora de yoga. Me fui 35 días sola a Grecia sin saber para dónde iba. Nunca pensé que iba a echarme un viaje a Europa sola.
          </div>
          <div style={{ fontSize: 14, color: C.muted, lineHeight: 1.8, marginBottom: 14 }}>
