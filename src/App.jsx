...
function App() {
  ...
  const programasView = (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{
        ...
        {showFullStory && <>
          <div style={{ fontSize: 14, color: C.muted, lineHeight: 1.8, marginBottom: 14 }}>
            Desde los 16 años pasé por diagnósticos que no eran míos. Pasé por malos diagnósticos, por depresión. Hasta que llegué al DBT y eso me cambió la vida. Me certifiqué como profesora de yoga. Me fui 35 días sola a Grecia. En ese camino sentí que había mucha soledad — y que faltaba conexión.
          </div>
          <div style={{ fontSize: 14, color: C.muted, lineHeight: 1.8, marginBottom: 14 }}>
  ...
  const SEED_DIRECTORIO = [
    { id: 'd1', name: 'Dra. Camila Restrepo', title: 'Psicóloga clínica', cat: 'salud_mental', city: 'Cartagena', desc: 'Especialista en ansiedad, depresión y altas capacidades. 8 años de experiencia. Terapia DBT y cognitivo-conductual.', price: 'Desde $120.000/sesión', verified: true, rating: 4.9, reviews: 47 },
